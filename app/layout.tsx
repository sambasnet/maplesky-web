...
export const metadata: Metadata = {
  ...
  title: {
    default: 'MapleSky Travels - Redefining Travel',
    template: '%s | MapleSky Travels',
  },
  description: 'MapleSky Travels is coming soon. Redefining the travel industry with innovative solutions and exceptional experiences.',
  ...
  openGraph: {
    ...
    locale: 'en_US',
    url: '/',
    siteName: 'MapleSky Travels',
    title: 'MapleSky Travels - Redefining Travel',
    description: 'MapleSky Travels is coming soon. Redefining the travel industry with innovative solutions.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
        height: 630,
        alt: 'MapleSky Travels',
      },
    ],
  },
  twitter: {
